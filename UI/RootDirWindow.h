...
{
public:
	RootDirWindow(wxWindow* parent, const wxString& rootDir, wxWindowID id = wxID_ANY, const wxString& title = wxT("Select game folder"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize(515, 170), long style = wxDEFAULT_DIALOG_STYLE);
	~RootDirWindow();
